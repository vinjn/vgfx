...
void init_tiny_renderer(GLFWwindow* window)
{
    ...
    tr_create_structured_buffer(m_renderer, buffer_size, 0, element_count, struct_stride, false,
                                &m_compute_src_buffer);
    tr_queue_update_buffer(m_renderer->graphics_queue, buffer_size, input_buffer.data(),
                           m_compute_src_buffer);
